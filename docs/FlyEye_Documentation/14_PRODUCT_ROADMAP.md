...
6. FEAT-005 User Management and Basic Profiles — locally implemented, verified, and independently reviewed; PR/CI pending
7. FEAT-006 Role Assignment — next planned specification after FEAT-005 merge
