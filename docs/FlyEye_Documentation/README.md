...
| [FEAT-002 Password Recovery](features/FEAT-002_PASSWORD_RECOVERY.md) | Documentation-complete recovery specification; implementation and human review remain pending |
