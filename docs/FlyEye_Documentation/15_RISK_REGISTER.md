...
| R-29 | Minor-student data is processed without sufficient authority or safeguards | Medium | Very High | DPO/legal review, controller-approved guardian authority or consent, notices, minimization, access and retention controls | Stop affected processing; preserve evidence; controller/DPO assessment |
| R-30 | Administrative and operational authority is combined without approved separation of duties | Medium | Very High | Admin-only system authority, explicit roles, one initial role per membership, MFA, reauthentication, audit, approved permission matrix | Suspend affected authority; review actions; correct roles and evidence |
| R-31 | Commercial ownership or licensing expectations conflict | Medium | High | Founder-retained platform IP as intended default, customer data ownership, reviewed license/subscription or assignment contract | Pause sale/onboarding; obtain legal review and written agreement |
